...
![A平台的系统提示词](../assets/images/A平台的LLM.png)
![B平台的系统提示词](../assets/images/B平台的LLM.png)
![C平台的系统提示词](../assets/images/C平台的LLM.png)
![D平台的系统提示词（失败效果）](../assets/images/D平台LLM（失败）.png)
![D平台的系统提示词（成功效果）](../assets/images/D平台的LLM（成功）.png)
